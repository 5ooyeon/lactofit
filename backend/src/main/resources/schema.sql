...
VALUES
(1, 1, "Check out my new workout routine!", 'workout1.jpg', 100, NOW(), NOW(), 1),
(2, 2, "Just finished a tough session", 'session2.jpg', 150, NOW(), NOW(), 1),
(3, 3, "Loving the new exercises", 'exercise3.jpg', 200, NOW(), NOW(), 1),
(4, 4, "Feeling great after this workout", 'workout4.jpg', 250, NOW(), NOW(), 1),
(5, 5, "Here's my progress", 'progress5.jpg', 300, NOW(), NOW(), 1),
(6, 6, "My favorite exercises", 'favorites6.jpg', 120, NOW(), NOW(), 1),
(7, 7, "Workout tips", 'tips7.jpg', 180, NOW(), NOW(), 1),
(8, 8, "Healthy lifestyle", 'lifestyle8.jpg', 220, NOW(), NOW(), 1),
(9, 9, "Gym day!", 'gym9.jpg', 170, NOW(), NOW(), 1),
(10, 10, "Outdoor workout", 'outdoor10.jpg', 210, NOW(), NOW(), 1),
(11, 1, "오늘의 운동 루틴을 공유합니다.", 'workout11.jpg', 130, NOW(), NOW(), 1),
(12, 2, "힘든 세션을 마쳤습니다.", 'session12.jpg', 140, NOW(), NOW(), 1),
(13, 3, "새로운 운동을 사랑합니다.", 'exercise13.jpg', 150, NOW(), NOW(), 1),
